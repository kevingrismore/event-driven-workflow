...
curl -X POST 'https://api.prefect.cloud/hooks/<REPLACE-ME>' -H "Content-Type: application/json" -d '{
  "event_name": "kickoff",
  "file_name": "example-file-succeed.csv",
  "stage": "on-prem",
  "trackingId": "aaa89264-c79c-11eb-b8bc-0242ac140008"
}'
sleep 10
...
curl -X POST 'https://api.prefect.cloud/hooks/<REPLACE-ME>' -H "Content-Type: application/json" -d '[{
  ...
  "data": {
    ...
    "blobType": "BlockBlob",
    "url": "https://my-storage-account.blob.core.windows.net/testcontainer/example-file-succeed.csv",
